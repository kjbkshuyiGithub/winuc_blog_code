...
export default async function SettingsPage() {
  ...
  const tabs = [
    { label: '个人资料', href: '/dashboard/settings', isActive: true },
        ...
        <div className="mt-6">
          <SettingsLayout>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">个人资料</h2>
              <ProfileForm />
            </div>
          </SettingsLayout>
        </div>
